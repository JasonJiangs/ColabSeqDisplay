...
Copied so that ColabSeqDisplay installs without the research checkout. The encoding was
checked against the original on the bundled 16,424-variant SlugCas9 library: the arrays
are identical.
